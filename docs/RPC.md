...
maps eight MCP tools to status, opt-in website notifications, HTML and image
capture, page attachment and action, and session and proxy listing. MCP does not add an HTTP `/mcp` route or
