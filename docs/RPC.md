...
A browser operation resolves its target session without replacing an existing
selection or activating REL. This presentation behavior does not change RPC
results or session behavior.
